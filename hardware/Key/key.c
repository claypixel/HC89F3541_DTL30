...
u8 key_scan(void)
{
    ...
    else if (key_up && (KEY_1 == 0) && (g_Var_system.bCalibration_std == 0))
    {
        key_up = 0;
        return LED_STAY_ON;
    }
    if (Calibration_key_driver() ==  KEY_CALI2_LONG)
    {
        ...
        {
            g_Var_system.bCalibration_std = 1;
            flash_info.correct_std = 1;
            flah_save_data();
        }
        else
        {
            g_Var_system.bCalibration_std = 0;
        }
    }
    else if (key_up && (KEY_2 == 0 || KEY_3 == 0) && (g_Var_system.bCalibration_std == 0))
    {
        key_up = 0;
        if (KEY_2 == 0)
        {
